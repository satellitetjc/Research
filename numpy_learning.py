...
trainIn = np.zeros((groundTruth.shape[0] - 2 * n, groundTruth.shape[1] - 2 * n, squareDim, squareDim, channels)) #训练的输入
trainOut = np.zeros((groundTruth.shape[0] - 2 * n, groundTruth.shape[1] - 2 * n)) #训练的输出
